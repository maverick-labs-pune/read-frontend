...
class BookFairySessionDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      readOnly: false
  ...
  render() {
          ...
          <div key={i} className="row mt20">
            <div className="col">
              <SessionClassroomStudentsTable
                ...
                onClassroomSave={onClassroomSave}
                levels={levels}
                books={books}
    ...
    return (
      <div>
        ...
        <div className="mt20 school-details-container">
...
export default withRouter(BookFairySessionDetails);
