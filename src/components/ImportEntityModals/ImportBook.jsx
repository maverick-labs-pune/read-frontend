...
import ImportBookTable from "../ItemTables/ImportBookTable";
...
class ImportBook extends Component {
  render() {
    ...
    return (
      <Modal
        isOpen={isOpen}
        onRequestClose={toggleImportBookModal}
        ariaHideApp={false}
      ...
      >
        <ModalContent>
          <ModalHeader
            title="Import Book"
            toggleModal={toggleImportBookModal}
          />
          ...
          <div className="justify-content-start modal-footer">
            ...
            <Button secondary onClick={toggleImportBookModal}>
              Cancel
            </Button>
          </div>
        </ModalContent>
