...
class ExportQRCode extends Component {
  render() {
    const {
      selectedFileName,
      books,
    ...
    isFileSelected =
      isValid(selectedFileName) > 0 ? (
        ...
        <div className="col-md-12 col-lg-12">
          Please select a file to import and generate QR Code.
        </div>
      );
    importComponent = (
    ...
    return (
      ...
      >
        <ModalContent>
          <ModalHeader
            title={"Import file and generate QR Code"}
          ...
          <div className="justify-content-start modal-footer">
            <Button onClick={onImportBook} primary loading={fileUploadLoading}>
              Upload
            </Button>
          </div>
        </ModalContent>
