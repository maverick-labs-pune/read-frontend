...
import BookFairyBookLendingSessionDetails from "../../components/SessionDetails/BookFairyBookLendingSessionDetails";
import cloneDeep from "lodash/cloneDeep";
import find from "lodash/find";
import reduce from "lodash/reduce";
import { isValid } from "../../utils/stringUtils";
import { LOCALE_MARATHI, REGULAR, EVALUATION } from "../../utils/constants";
...
class BookFairySessionDetailContainer extends Component {
              ...
              instance.spread(
                (
                  ...
                  forEach(levels.data, item => {
                    if (readSession.data.type === REGULAR) {
                      if (item.is_regular === true) {
                        levelDropdown.push({
                          value: item.key,
                          label:
                    ...
                    if (readSession.data.type === EVALUATION) {
                      if (item.is_evaluation === true) {
                        levelDropdown.push({
                          value: item.key,
                          label:
                            locale === LOCALE_MARATHI
  ...
  bindStudentDetails = (classrooms, levels, evaluations) => {
    ...
    return (
      <div>
        {type === "READ_SESSION_BOOK_LENDING" ? (
          <BookFairyBookLendingSessionDetails
